...
@Component({
  selector: 'app-discharge-special-instruction',
  standalone: false,
  templateUrl: './discharge-special-instruction.component.html',
  styleUrl: './discharge-special-instruction.component.scss'
})
export class DischargeSpecialInstructionComponent implements OnInit {
